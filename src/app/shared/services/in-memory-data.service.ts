...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    ...
    const menu = [
      ...
      { id: 3, title: "List of Commodities", link: "/commodity"},
      { id: 4, title: "Gallery", link: "/gallery"},
      { id: 5, title: "Documents", link: "/document"},
      { id: 6, title: "Events", link: "/events"},
      { id: 7, title: "Contact Us", link: "/pricing"},
      { id: 8, title: "Director List", link:"/director"}
    ];
    const companies = [
      {
        id: 1,
